...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  WithdrawAddrResponse GetWithdrawInfo(WithdrawAddrRequest req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "GetWithdrawInfo":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "GetWithdrawInfo requires 1 args")
			flag.Usage()
		}
		arg46 := flag.Arg(1)
		...
		argvalue0 := model.NewWithdrawAddrRequest()
		...
		value0 := argvalue0
		fmt.Print(client.GetWithdrawInfo(context.Background(), value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
