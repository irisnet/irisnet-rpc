...
type IRISHubService interface {
	...
	// Parameters:
	//  - Req
	GetWithdrawInfo(ctx context.Context, req *WithdrawAddrRequest) (r *WithdrawAddrResponse, err error)
}
...
// Parameters:
//  - Req
func (p *IRISHubServiceClient) GetWithdrawInfo(ctx context.Context, req *WithdrawAddrRequest) (r *WithdrawAddrResponse, err error) {
	var _args10 IRISHubServiceGetWithdrawInfoArgs
	_args10.Req = req
	var _result11 IRISHubServiceGetWithdrawInfoResult
	if err = p.c.Call(ctx, "GetWithdrawInfo", &_args10, &_result11); err != nil {
		return
	}
	switch {
...
func NewIRISHubServiceProcessor(handler IRISHubService) *IRISHubServiceProcessor {
	...
	self12.processorMap["GetWithdrawInfo"] = &iRISHubServiceProcessorGetWithdrawInfo{handler: handler}
	return self12
}
...
type iRISHubServiceProcessorGetWithdrawInfo struct {
	handler IRISHubService
}

func (p *iRISHubServiceProcessorGetWithdrawInfo) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := IRISHubServiceGetWithdrawInfoArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetWithdrawInfo", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush()
		return false, err
	...
	iprot.ReadMessageEnd()
	result := IRISHubServiceGetWithdrawInfoResult{}
	var retval *WithdrawAddrResponse
	var err2 error
	if retval, err2 = p.handler.GetWithdrawInfo(ctx, args.Req); err2 != nil {
		switch v := err2.(type) {
		case *Exception:
			result.E = v
		default:
			x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetWithdrawInfo: "+err2.Error())
			oprot.WriteMessageBegin("GetWithdrawInfo", thrift.EXCEPTION, seqId)
			x.Write(oprot)
			oprot.WriteMessageEnd()
			oprot.Flush()
	...
	if err2 = oprot.WriteMessageBegin("GetWithdrawInfo", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
// Attributes:
//  - Req
type IRISHubServiceGetWithdrawInfoArgs struct {
	Req *WithdrawAddrRequest `thrift:"req,1" db:"req" json:"req"`
}

func NewIRISHubServiceGetWithdrawInfoArgs() *IRISHubServiceGetWithdrawInfoArgs {
	return &IRISHubServiceGetWithdrawInfoArgs{}
}

var IRISHubServiceGetWithdrawInfoArgs_Req_DEFAULT *WithdrawAddrRequest

func (p *IRISHubServiceGetWithdrawInfoArgs) GetReq() *WithdrawAddrRequest {
	if !p.IsSetReq() {
		return IRISHubServiceGetWithdrawInfoArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *IRISHubServiceGetWithdrawInfoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *IRISHubServiceGetWithdrawInfoArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *IRISHubServiceGetWithdrawInfoArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = &WithdrawAddrRequest{}
	if err := p.Req.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Req), err)
	}
	return nil
...
func (p *IRISHubServiceGetWithdrawInfoArgs) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("GetWithdrawInfo_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField1(oprot); err != nil {
...
func (p *IRISHubServiceGetWithdrawInfoArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:req: ", p), err)
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *IRISHubServiceGetWithdrawInfoArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("IRISHubServiceGetWithdrawInfoArgs(%+v)", *p)
}

// Attributes:
//  - Success
//  - E
type IRISHubServiceGetWithdrawInfoResult struct {
	Success *WithdrawAddrResponse `thrift:"success,0" db:"success" json:"success,omitempty"`
	E       *Exception            `thrift:"e,1" db:"e" json:"e,omitempty"`
}

func NewIRISHubServiceGetWithdrawInfoResult() *IRISHubServiceGetWithdrawInfoResult {
	return &IRISHubServiceGetWithdrawInfoResult{}
}

var IRISHubServiceGetWithdrawInfoResult_Success_DEFAULT *WithdrawAddrResponse

func (p *IRISHubServiceGetWithdrawInfoResult) GetSuccess() *WithdrawAddrResponse {
	if !p.IsSetSuccess() {
		return IRISHubServiceGetWithdrawInfoResult_Success_DEFAULT
	}
	return p.Success
}

var IRISHubServiceGetWithdrawInfoResult_E_DEFAULT *Exception

func (p *IRISHubServiceGetWithdrawInfoResult) GetE() *Exception {
	if !p.IsSetE() {
		return IRISHubServiceGetWithdrawInfoResult_E_DEFAULT
	}
	return p.E
}
func (p *IRISHubServiceGetWithdrawInfoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *IRISHubServiceGetWithdrawInfoResult) IsSetE() bool {
	return p.E != nil
}

func (p *IRISHubServiceGetWithdrawInfoResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *IRISHubServiceGetWithdrawInfoResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = &WithdrawAddrResponse{}
	if err := p.Success.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
	}
	return nil
...
func (p *IRISHubServiceGetWithdrawInfoResult) ReadField1(iprot thrift.TProtocol) error {
	p.E = &Exception{}
	if err := p.E.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.E), err)
	}
...
func (p *IRISHubServiceGetWithdrawInfoResult) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("GetWithdrawInfo_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if p != nil {
		if err := p.writeField0(oprot); err != nil {
...
func (p *IRISHubServiceGetWithdrawInfoResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *IRISHubServiceGetWithdrawInfoResult) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetE() {
		if err := oprot.WriteFieldBegin("e", thrift.STRUCT, 1); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:e: ", p), err)
		}
...
func (p *IRISHubServiceGetWithdrawInfoResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("IRISHubServiceGetWithdrawInfoResult(%+v)", *p)
}
